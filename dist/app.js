...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"node_modules/v-click-outside/dist/v-click-outside.umd.js":[function(require,module,exports) {
var define;
...
},{}],"src/Main.vue":[function(require,module,exports) {
"use strict";
...
var _vClickOutside = _interopRequireDefault(require("v-click-outside"));
...
var _default = {
  directives: {
    clickOutside: _vClickOutside.default.directive
  },
  methods: {
    toggleSidebar: function toggleSidebar() {
      this.sidebarCollapsed = !this.sidebarCollapsed;
    },
    openProfileCard: function openProfileCard(open) {
  ...
  mounted: function mounted() {
    ...
    this.$inertia.on('success', function () {
...
exports.default = _default;
        var $f97aea = exports.default || module.exports;
      
      if (typeof $f97aea === 'function') {
        $f97aea = $f97aea.options;
      }
    
        /* template */
        Object.assign($f97aea, (function () {
          var render = function() {
  var _vm = this
  ...
  return _c("div", { staticClass: "wrapper" }, [
    _c(
      "nav",
      {
        class: ["sidebar ", _vm.sidebarCollapsed ? "collapsed" : null],
        attrs: { id: "sidebar" }
      },
      [
        _c(
          "div",
          { staticClass: "sidebar-content js-simplebar" },
          [
            _c(
              "inertia-link",
              { staticClass: "sidebar-brand", attrs: { href: "/menu" } },
              [_c("span", { staticClass: "align-middle" }, [_vm._v("SIAP")])]
            ),
            _vm._v(" "),
            _c("ul", { staticClass: "sidebar-nav" }, [
              ...
              _c(
                "li",
                {
                  class: [
                    "sidebar-item",
                    _vm.$route().current("users.*") ? "active" : null
                  ]
                },
                [
                  _c(
                    "inertia-link",
                    { staticClass: "sidebar-link", attrs: { href: "/users" } },
                    [
                      _c("i", {
                        staticClass: "align-middle",
                        attrs: { "data-feather": "sliders" }
                      }),
                      _vm._v(" "),
              ...
              _c(
                "li",
                {
                  class: [
                    "sidebar-item",
                    _vm.$route().current("families.*") ? "active" : null
                  ]
                },
                [
                  _c(
              ...
              _c(
                "li",
                {
                  class: [
                    "sidebar-item",
                    _vm.$route().current("clusters.*") ? "active" : null
                  ]
                },
                [
                  _c(
              ...
              _c(
                "li",
                {
                  class: [
                    "sidebar-item",
                    _vm.$route().current("cluster_blocks.*") ? "active" : null
                  ]
                },
                [
                  _c(
              ...
              _c(
                "li",
                {
                  class: [
                    "sidebar-item",
                    _vm.$route().current("cluster_units.*") ? "active" : null
                  ]
                },
                [
                  _c(
              ...
              _c(
                "li",
                {
                  class: [
                    "sidebar-item",
                    _vm.$route().current("admins.*") ? "active" : null
                  ]
                },
                [
                  _c(
                    "inertia-link",
                    { staticClass: "sidebar-link", attrs: { href: "/admins" } },
                    [
                      _c("i", {
                        staticClass: "align-middle",
                        attrs: { "data-feather": "sliders" }
              ...
              _c(
                "li",
                {
                  class: [
                    "sidebar-item",
                    _vm.$route().current("invoices.*") ? "active" : null
                  ]
                },
                [
                  _c(
              ...
              _c(
                "li",
                {
                  class: [
                    "sidebar-item",
                    _vm.$route().current("receipts.*") ? "active" : null
                  ]
                },
                [
                  _c(
      ...
      _c(
        ...
        [
          _c(
            "a",
            {
              staticClass: "sidebar-toggle d-flex",
              on: {
                  ...
                  directives: [
                    {
                      ...
                      value: function() {
                        return _vm.openProfileCard(false)
                      },
                      expression: "() => openProfileCard(false)"
                    }
                  ],
                    ...
                    "a",
                    {
                      ...
                      on: {
                        click: function($event) {
                          ...
                          return _vm.openProfileCard(true)
                        }
                      }
                    },
                    [
                  ...
                  _c(
                    ...
                    [
                      _c("span", { staticClass: "text-dark" }, [
                        _vm._v(
                          _vm._s(
                            _vm.$inertia.page.props.current_user
                              ? _vm.$inertia.page.props.current_user
                                  .user_full_name
                              : null
                          )
                  ...
                  _c(
                    "div",
                    {
                      class: [
                        ...
                        _vm.isProfileCardOpen ? "show" : null
                      ]
                    },
                    [
                      _vm._m(0),
...
var staticRenderFns = [
  function() {
    ...
    return _c(
      "a",
      { staticClass: "dropdown-item flex", attrs: { href: "/profile" } },
      [
        _c("i", {
        ...
        _c("div", { staticClass: "row text-muted" }, [
          _c("div", { staticClass: "col-6 text-left" }, [
            _c("p", { staticClass: "mb-0" }, [
              _c("a", { staticClass: "text-muted", attrs: { href: "/menu" } }, [
                _c("strong", [_vm._v("SIAP")])
              ]),
              _vm._v(" © \n            ")
            ])
          ]),
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$f97aea', $f97aea);
          } else {
            api.reload('$f97aea', $f97aea);
          }
        }
...
},{"v-click-outside":"node_modules/v-click-outside/dist/v-click-outside.umd.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"app.js":[function(require,module,exports) {
var Main = require('./src/Main.vue');

module.exports = {
  Main: Main
};
},{"./src/Main.vue":"src/Main.vue"}],"../../../../usr/local/share/.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "43065" + '/');
